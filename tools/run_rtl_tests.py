...
ARITH_SOURCES = {
    ...
    "tb_requantize": ["rtl/requantize_from_product.sv", "rtl/requantize.sv"],
    "tb_saturate_int8": ["rtl/saturate_int8.sv"],
    "tb_conv_single_output": [
        "rtl/int8_mac.sv",
        "rtl/requantize_from_product.sv", "rtl/requantize.sv",
        "rtl/relu_int8.sv",
...
FC_SOURCES = {
    ...
    "tb_fully_connected_selected_class": [
        ...
        "rtl/int8_mac.sv",
        "rtl/fc_logit_from_product.sv", "rtl/fc_output_postprocess.sv",
