// tb_cnn_pingpong_end_to_end.sv
// Ping-pong activation RAM end-to-end regression.
//
...
module tb_cnn_pingpong_end_to_end (
    input logic clk
);
    ...
    cnn_accelerator_pingpong_top dut (
    ...
    task automatic compare_shadows;
        begin
            ...
            $display("Ping-pong intermediates OK: c1=%0d p1=%0d c2=%0d p2=%0d writes matched",
    ...
    always @(posedge clk) begin
        ...
        if (phase == 4) begin
            ...
            $display("==== Ping-pong single-image pass 1 ====");
            ...
            $display("pingpong layer cycles: Conv1=%0d Conv2=%0d",
        ...
        if (phase == 6 && done) begin
            ...
            $display("==== Ping-pong repeated inference PASS (cycles=%0d) ====",
                     cycle_count);
            phase = 7;
            local_c = 0;
        end
        ...
        if (phase == 8 && done) begin
            ...
            $display("==== Ping-pong reset-during-inference recovery PASS ====");
            img = 0;
            load_sample(0);
        ...
        if (phase == 12 && done) begin
            ...
            $display("PASS ping-pong image %0d class=%0d cycles=%0d",
                     img, predicted_class, cycle_count);
            img = img + 1;
            if (img >= NUM_IMG) begin
                $display("PASS: tb_cnn_pingpong_end_to_end");
