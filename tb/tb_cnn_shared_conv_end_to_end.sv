// tb_cnn_shared_conv_end_to_end.sv
// Shared-conv activation RAM end-to-end regression.
//
...
module tb_cnn_shared_conv_end_to_end (
    input logic clk
);
    ...
    cnn_accelerator_shared_conv_top dut (
    ...
    task automatic compare_shadows;
        begin
            ...
            $display("Shared-conv intermediates OK: c1=%0d p1=%0d c2=%0d p2=%0d writes matched",
    ...
    always @(posedge clk) begin
        ...
        if (phase == 4) begin
            ...
            $display("==== Shared-conv single-image pass 1 ====");
            ...
            $display("shared-conv layer cycles: Conv1=%0d Conv2=%0d",
                     dbg_conv1_cycles, dbg_conv2_cycles);
        ...
        if (phase == 6 && done) begin
            ...
            $display("==== Shared-conv repeated inference PASS (cycles=%0d) ====",
                     cycle_count);
            phase = 7;
            local_c = 0;
        end
        ...
        if (phase == 8 && done) begin
            ...
            $display("==== Shared-conv reset-during-inference recovery PASS ====");
            img = 0;
            load_sample(0);
        ...
        if (phase == 12 && done) begin
            ...
            $display("PASS shared-conv image %0d class=%0d cycles=%0d",
                     img, predicted_class, cycle_count);
            img = img + 1;
            if (img >= NUM_IMG) begin
                $display("PASS: tb_cnn_shared_conv_end_to_end");
